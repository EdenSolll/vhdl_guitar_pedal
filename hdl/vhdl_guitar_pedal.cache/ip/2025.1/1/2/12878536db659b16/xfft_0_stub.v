...
(* CHECK_LICENSE_TYPE = "xfft_0,xfft_v9_1_14,{}" *) (* core_generation_info = "xfft_0,xfft_v9_1_14,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=xfft,x_ipVersion=9.1,x_ipCoreRevision=14,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_XDEVICEFAMILY=artix7,C_PART=xc7a35tcpg236-1,C_S_AXIS_CONFIG_TDATA_WIDTH=8,C_S_AXIS_DATA_TDATA_WIDTH=48,C_M_AXIS_DATA_TDATA_WIDTH=48,C_M_AXIS_DATA_TUSER_WIDTH=24,C_M_AXIS_STATUS_TDATA_WIDTH=8,C_THROTTLE_SCHEME=1,C_NSSR=1,C_CHANNELS=1,C_NFFT_MAX=10,C_ARCH=2,C_HAS_NFFT=0,C_USE_FLT_PT=0,C_INPUT_WIDTH=24,C_TWIDDLE_WIDTH=24,C_OUTPUT_WIDTH=24,C_HAS_SCALING=1,C_HAS_BFP=1,C_HAS_ROUNDING=1,C_HAS_ACLKEN=0,C_HAS_ARESETN=1,C_HAS_OVFLO=0,C_HAS_NATURAL_INPUT=1,C_HAS_NATURAL_OUTPUT=1,C_HAS_CYCLIC_PREFIX=0,C_HAS_XK_INDEX=1,C_DATA_MEM_TYPE=1,C_TWIDDLE_MEM_TYPE=1,C_BRAM_STAGES=0,C_REORDER_MEM_TYPE=1,C_USE_HYBRID_RAM=1,C_OPTIMIZE_GOAL=0,C_CMPY_TYPE=2,C_BFLY_TYPE=0,C_SYSTOLICFFT_INV=0,C_IS_BLOCKING_RUNTIME_CONF=0}" *) (* downgradeipidentifiedwarnings = "yes" *) 

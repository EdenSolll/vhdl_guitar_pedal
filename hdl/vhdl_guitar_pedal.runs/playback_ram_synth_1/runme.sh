...
HD_PWD='/users/u31/sol/vhdl_guitar_pedal/hdl/vhdl_guitar_pedal.runs/playback_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log playback_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source playback_ram.tcl

...
set genomeRtd $env(RT_TMP)/5B0D7240.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {case__17_guitar_pedal__GD}]"
...
set genomeName [subst -nocommands -novariables {case__17_guitar_pedal__GD}]

...
set genomeRtd $env(RT_TMP)/C11C7B80.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {guitar_pedal_GT1}]"
...
set genomeName [subst -nocommands -novariables {guitar_pedal_GT1}]

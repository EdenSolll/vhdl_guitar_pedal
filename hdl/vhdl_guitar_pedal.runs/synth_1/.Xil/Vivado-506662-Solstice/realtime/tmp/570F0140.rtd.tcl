...
set genomeRtd $env(RT_TMP)/570F0140.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {guitar_pedal__GCB2}]"
...
set genomeName [subst -nocommands -novariables {guitar_pedal__GCB2}]

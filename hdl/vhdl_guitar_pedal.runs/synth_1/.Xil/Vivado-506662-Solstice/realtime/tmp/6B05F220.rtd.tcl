...
set genomeRtd $env(RT_TMP)/6B05F220.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {muxpart__1028_pitch_shift}]"
...
set genomeName [subst -nocommands -novariables {muxpart__1028_pitch_shift}]

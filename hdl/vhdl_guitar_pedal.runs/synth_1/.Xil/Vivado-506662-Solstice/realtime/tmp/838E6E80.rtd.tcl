...
set genomeRtd $env(RT_TMP)/838E6E80.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {pitch_shift__GB0}]"
...
set genomeName [subst -nocommands -novariables {pitch_shift__GB0}]

...
set genomeRtd $env(RT_TMP)/7726D040.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {guitar_pedal__GCB1}]"
...
set genomeName [subst -nocommands -novariables {guitar_pedal__GCB1}]

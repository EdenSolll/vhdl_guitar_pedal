...
HD_PWD='/users/u31/sol/vhdl_guitar_pedal/hdl/vhdl_guitar_pedal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log guitar_pedal.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source guitar_pedal.tcl

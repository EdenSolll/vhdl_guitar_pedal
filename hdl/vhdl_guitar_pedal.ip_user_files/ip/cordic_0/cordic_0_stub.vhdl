...
-- Date        : Fri Jul 17 14:01:57 2026
-- Host        : jet.csh.rit.edu running 64-bit Rocky Linux 9.8 (Blue Onyx)"
RELEASE_TYPE="stable
-- Command     : write_vhdl -force -mode synth_stub
--               /users/u31/sol/vhdl_guitar_pedal/hdl/vhdl_guitar_pedal.gen/sources_1/ip/cordic_0/cordic_0_stub.vhdl
-- Design      : cordic_0
...
architecture stub of cordic_0 is
  ...
  attribute black_box_pad_pin of stub : architecture is "aclk,aresetn,s_axis_cartesian_tvalid,s_axis_cartesian_tlast,s_axis_cartesian_tdata[47:0],m_axis_dout_tvalid,m_axis_dout_tlast,m_axis_dout_tdata[47:0]";
  ...
  attribute x_interface_parameter of s_axis_cartesian_tvalid : signal is "XIL_INTERFACENAME S_AXIS_CARTESIAN, TDATA_NUM_BYTES 6, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 0, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute x_interface_parameter of m_axis_dout_tvalid : signal is "XIL_INTERFACENAME M_AXIS_DOUT, TDATA_NUM_BYTES 6, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 0, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 100000000, PHASE 0.0, LAYERED_METADATA undef, INSERT_VIP 0";
  ...
  attribute x_core_info of stub : architecture is "cordic_v6_0_26,Vivado 2026.1";
begin
end;

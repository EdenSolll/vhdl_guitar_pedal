...
design_libs=(xpm blk_mem_gen_v8_4_13 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../xilinx_host/Xilinx/2026.1/data/rsb/busdef" \
  ...
  vlogan -work blk_mem_gen_v8_4_13 $vlogan_opts +v2k +incdir+"../../../../../../xilinx_host/Xilinx/2026.1/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../../../xilinx_host/Xilinx/2026.1/data/rsb/busdef" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.playback_ram xil_defaultlib.glbl -o playback_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./playback_ram_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/users/u31/sol/vhdl_guitar_pedal/hdl/vhdl_guitar_pedal.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key playback_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc playback_ram_simv.daidir vcs_lib c.obj)

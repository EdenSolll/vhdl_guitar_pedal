...
export RDI_DATADIR="/users/u31/sol/xilinx_host/Xilinx/2026.1/data"
...
elaborate()
{
  xelab --debug typical --relax --mt 8  -L xil_defaultlib -L blk_mem_gen_v8_4_13 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot playback_ram xil_defaultlib.playback_ram xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim playback_ram -key {Behavioral:sim_1:Functional:playback_ram} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/users/u31/sol/xilinx_host/Xilinx/2026.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb playback_ram.wdb xsim.dir libdpi.so)

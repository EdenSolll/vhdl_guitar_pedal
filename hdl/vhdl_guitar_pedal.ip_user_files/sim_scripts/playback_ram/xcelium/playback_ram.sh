...
#
# Script generated by Vivado on Wed Jul 22 15:51:42 EDT 2026
# SW Build 6511674 on Tue Jun 16 11:01:26 MDT 2026
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2026 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : playback_ram.sh
...
#
# Usage        : playback_ram.sh
#                playback_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                playback_ram.sh [-rerun]
#                playback_ram.sh [-reset_run]
#                playback_ram.sh [-clean]
#                playback_ram.sh [-reset_log]
#                playback_ram.sh [-help]
#
...
#                script (type 'playback_ram.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname blk_mem_gen_v8_4_13 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm blk_mem_gen_v8_4_13 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "playback_ram.sh - Script generated by export_simulation (Vivado v2026.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./playback_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../../../xilinx_host/Xilinx/2026.1/data/rsb/busdef" \
  ...
  xmvlog -work blk_mem_gen_v8_4_13 $xmvlog_opts +incdir+"../../../../../../xilinx_host/Xilinx/2026.1/data/rsb/busdef" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../../../xilinx_host/Xilinx/2026.1/data/rsb/busdef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.playback_ram xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.playback_ram -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/users/u31/sol/vhdl_guitar_pedal/hdl/vhdl_guitar_pedal.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log playback_ram_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./playback_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: playback_ram.sh [-help]\n\
Usage: playback_ram.sh [-step]\n\
Usage: playback_ram.sh [-lib_map_path]\n\
Usage: playback_ram.sh [-rerun]\n\
Usage: playback_ram.sh [-reset_run]\n\
Usage: playback_ram.sh [-clean]\n\
Usage: playback_ram.sh [-reset_log]\n\
Usage: playback_ram.sh [-keep_index]\n\
Usage: playback_ram.sh [-noclean_files]\n\n\

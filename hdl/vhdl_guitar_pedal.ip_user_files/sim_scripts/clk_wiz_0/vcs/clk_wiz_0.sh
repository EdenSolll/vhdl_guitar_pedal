...
#
# Script generated by Vivado on Fri May 22 20:45:39 EDT 2026
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../../Xilinx/Vivado/2025.1/data/rsb/busdef" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../../Xilinx/Vivado/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/Sol/vhdl_guitar_pedal/vhdl_guitar_pedal.cache/compile_simlib/vcs"
  fi

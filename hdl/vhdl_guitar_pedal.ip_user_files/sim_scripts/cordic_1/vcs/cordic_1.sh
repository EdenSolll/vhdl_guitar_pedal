...
design_libs=(xpm xbip_utils_v3_0_14 c_reg_fd_v12_0_10 xbip_dsp48_wrapper_v3_0_7 xbip_pipe_v3_0_10 c_addsub_v12_0_20 mult_gen_v12_0_23 axi_utils_v2_0_10 cordic_v6_0_24 xil_defaultlib)
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../../../Xilinx/Vivado/2025.1/data/rsb/busdef" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/Sol/vhdl_guitar_pedal/hdl/vhdl_guitar_pedal.cache/compile_simlib/vcs"
  fi
